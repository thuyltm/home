...
func main() {
	...
	router.Use(RequestMetricsMiddleware()) //middleware
...
func PrometheusHandler() gin.HandlerFunc { //expose promotheus metric via http
...
// Middleware to record incoming requests metric
func RequestMetricsMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		path := c.Request.URL.Path

		c.Next() //call the next middleware in the chain
