...
resource "vault_generic_endpoint" "denielle-user" {
...
# the policy developer-vault-policy use a secret engine on the dev-secrets/* path
...
# create a new secrets engine at dev-secrets
