...
resource "kubernetes_resource_quota" "example" {
  ...
  spec {
    hard = {
      "pods"            = 1
      "requests.cpu"    = var.resource_requests_cpu
      "requests.memory" = var.resource_requests_memory
      "limits.cpu"      = var.resource_limits_cpu
      "limits.memory"   = var.resource_limits_memory
    }
  }
}
