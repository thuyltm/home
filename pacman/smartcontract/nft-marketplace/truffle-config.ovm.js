...
module.exports = {
  ...
  */
  ...
  networks: {
    ...
    ganache: {
      host: "127.0.0.1",
      port: 7545,            // Match this with Ganache GUI port
    ...
    optimistic_sepolia: {
      ...
      chain_id: 11155420,
      provider: function () {
        return new HDWalletProvider(mnemonic, "https://optimism-sepolia.infura.io/v3/" + infuraKey);
      }
    },
    ...
    optimistic_mainnet: {
      ...
      chain_id: 10,
      provider: function () {
        return new HDWalletProvider(mainnetMnemonic, "https://optimism-mainnet.infura.io/v3/" + infuraKey);
      }
    },
    dashboard: {
      host: "127.0.0.1",
