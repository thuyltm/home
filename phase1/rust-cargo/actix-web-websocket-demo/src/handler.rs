...
use tokio::{pin, sync::broadcast, time::interval};
use tokio::select;

///How oftern heartbeat pings are sent.
///
...
/// Echo text & binary messages received from the client, respond to ping messages, 
...
pub async fn echo_heartbeat_ws(
    ...
    // attempt to close connection grafefully
...
/// Broadcast text & binary messages received from a client, respond to ping messages,
/// and monitor connection health to detect network issues and free up resources
