...
#####################################################################################
# To create credential and certificate configuration files for direct resource access
#####################################################################################
...
# [principal://iam.googleapis.com/projects/206108938560/locations/global/workloadIdentityPools/my-workload-pool/subject/example].
# Your current project is [articulate-run-306102]
#####################################################################################
gcloud auth login --cred-file=cred.json
#####################################################################################
# Perform token exchange with mTLS
#####################################################################################
...
####################################################################################################################################
# Grant the Role roles/Storage Object Viewer and roles/Storage Bucket Viewer to 
# external identities for google cloud bucket
####################################################################################################################################
gcloud storage buckets add-iam-policy-binding bucket-quickstart_articulate-run-306102 \
    --role=roles/storage.objectViewer \
    --member="principal://iam.googleapis.com/projects/206108938560/locations/global/workloadIdentityPools/my-workload-pool/subject/example"
###########################################################################################################################################
# Use an access token to access Google Cloud Storage
###########################################################################################################################################
